...
@Mod("pury_music")
public class PuryMusicMod {
	public static final Logger LOGGER = LogManager.getLogger(PuryMusicMod.class);
	...
	public PuryMusicMod() {
		...
		PuryMusicModSounds.REGISTRY.register(bus);

		PuryMusicModItems.REGISTRY.register(bus);

		PuryMusicModFeatures.REGISTRY.register(bus);
